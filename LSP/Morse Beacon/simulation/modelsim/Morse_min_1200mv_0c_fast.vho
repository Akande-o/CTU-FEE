...
-- A	=>  Location: PIN_C26,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
ARCHITECTURE structure OF BeaconAE IS
...
-- Equation(s):
-- \M~0_combout\ = (\D~input_o\ & (((\C~input_o\)) # (!\B~input_o\))) # (!\D~input_o\ & (\A~input_o\ & ((\C~input_o\) # (!\B~input_o\))))
