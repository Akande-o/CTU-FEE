...
def bayes_risk_discrete(discrete_A, discrete_B, W, q):
    ...
    R = float(np.sum(discrete_A['Prob']*discrete_A['Prior']*W[0,q] + discrete_B['Prob']*discrete_B['Prior']*W[1,q]))
    return R
...
def find_strategy_discrete(discrete_A, discrete_B, W):
    ...
    """
    q1 = discrete_A['Prob']*discrete_A['Prior']*W[0,0] + discrete_B['Prob']*discrete_B['Prior']*W[1,0]
    q2 = discrete_A['Prob']*discrete_A['Prior']*W[0,1] + discrete_B['Prob']*discrete_B['Prior']*W[1,1]
    q = 1*(q1>q2)
    return q
