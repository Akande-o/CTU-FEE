...
class ReversiCreator(object):
    ...
    def __init__(self, player_array):
        ...
        self.player1 = player_creator.create_player(players[0], self.player1_color, self.player2_color, BOARD_SIZE)
        self.player2 = player_creator.create_player(players[-1], self.player2_color, self.player1_color, BOARD_SIZE)
    ...
    def get_player_move(self, q):
        ...
        endTime = time.time()
        moveTime = (endTime - start_time) * 1000 # to display in milisecs
    ...
    def play_game(self, interactivePlayerColor=-1):
        ...
        while self.board.can_play( self.current_player_color) and not self.paused:
            ...
            if move_time > MAX_TIME_FOR_MOVE * 1000:
                print("running too long - killing it")
                player_move_overtime = self.current_player_color
...
if __name__ == "__main__": 
    ...
    players_dict = {'olasoolu':player.MyPlayer, 'olasoolu': player.MyPlayer, 'mit': mit_player.MyPlayer, 'CTU': ctu_player.MyPlayer, "Seun": seun_player.MyPlayer}
