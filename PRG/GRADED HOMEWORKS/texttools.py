...
def compute_word_importance(fpath1, fpath2):
    ...
    file1 = open(fpath1, "r", encoding = 'utf-8')  #open the first text file to gain access to its contents
    ...
    file2 = open(fpath2, "r", encoding = 'utf-8')  #open the second text file to gain access to its contents
